...
public class PauseScreen implements Screen {
    ...
    public PauseScreen(AngryBirdsGame game){
        ...
        resumeButtonTexture = new Texture("playButton.png");
        ...
        Drawable buttonDrawableResume = new TextureRegionDrawable(new TextureRegion(resumeButtonTexture));
        ...
        imageButtonResume = new ImageButton(buttonDrawableResume, buttonDrawableResume);
        imageButtonResume.setSize(175, 75);
        imageButtonResume.setPosition(200, 200);
        ...
        imageButtonResume.addListener(new ClickListener() {
            @Override
        ...
        stage.addActor(imageButtonResume);
